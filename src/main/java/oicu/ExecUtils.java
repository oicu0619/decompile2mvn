...
public class ExecUtils {
    public static void decompileJar(Path decompilerFile, Path jarFile, Path dstFolder) throws IOException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        try (URLClassLoader classLoader = new URLClassLoader(new URL[] {jarUrl})){
            ...
            mainMethod.invoke(null, (Object) new String[] {"-dgs=true", jarFile.toString(), dstFolder.toString()});
